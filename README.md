...
| `yutori.navigator.n2_results`                               | Render tool results exactly as the evaluation tools do (`format_batch_result`, `format_bash_result`, `format_cat_n`, `apply_edit`, …) when writing your own n2 computer adapter. |
